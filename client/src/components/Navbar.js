    ...
    const sideList = (
      <div className={classes.list}>
        <div className="navbar-drawer-header">
          ...
          <div className="navbar-drawer-text">HealthcareBlockchain</div>
        </div>
        <Divider />
        <List>
          {/* START LINK MENU */}
           ...
           <Link to="/doctors">
            <ListItem button key="Doctor">
              ...
              <ListItemText className="menu-text" primary="Doctor" />
            </ListItem>
          </Link>{" "}            
           <Link to="/patients">
            <ListItem button key="Patient">
              ...
              <ListItemText className="menu-text" primary="Patient" />
            </ListItem>
          </Link>{" "}            
           <Link to="/reports">
            <ListItem button key="Report">
              ...
              <ListItemText className="menu-text" primary="Report" />
            </ListItem>
          </Link>{" "} {/* END LINK MENU */}
        </List>
      </div>
